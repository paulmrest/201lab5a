...
//removed unnecessary variables and trying new Array() syntax
function sum(a, b) {
  return new Array (
    a + b, 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  return new Array (
    returnSum,
    returnProduct,
    a + ' and ' + b + ' and ' + c + ' sum to ' + returnSum + '.',
    'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + returnProduct + '.'
    );
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    var currElement = dynamicArray[i];
    returnProduct = multiply(returnProduct, currElement)[0];
    if (i == dynamicArray.length - 1) //if the last element in the array
    {
      returnString = returnString + currElement;
    }
    else //for all other elements
